...
SELECT * FROM BONUS;
-- FULL JOIN
SELECT W.* , B.* FROM WORKER AS W LEFT JOIN BONUS AS B ON W.WORKER_ID = B.WORKER_REF_ID UNION SELECT B.*,W.* FROM WORKER AS W RIGHT JOIN BONUS AS B ON W.WORKER_ID = B.WORKER_REF_ID;
